...
replace (
	...
	github.com/rancher/tfp-automation => github.com/rancher/tfp-automation v0.0.0-20260520220207-9b249cdac17b
...
require (
	...
	github.com/rancher/tfp-automation v0.0.0-20260520220207-9b249cdac17b
)
