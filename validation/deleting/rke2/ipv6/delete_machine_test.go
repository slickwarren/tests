...
type DeleteMachineIPv6TestSuite struct {
	suite.Suite
...
func (d *DeleteMachineIPv6TestSuite) TearDownSuite() {
	d.session.Cleanup()
}

func (d *DeleteMachineIPv6TestSuite) SetupSuite() {
...
func (d *DeleteMachineIPv6TestSuite) TestDeleteMachine() {
...
func TestDeleteMachineIPv6TestSuite(t *testing.T) {
	suite.Run(t, new(DeleteMachineIPv6TestSuite))
}
