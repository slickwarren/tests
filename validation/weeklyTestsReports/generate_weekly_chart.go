...
func main() {
	...
	cssBytes, err := os.ReadFile("validation/weeklyTestsReports/assets/style.css")
	if err != nil {
		logrus.Fatal(err)
	}

	jsBytes, err := os.ReadFile("validation/weeklyTestsReports/assets/toggle.js")
	if err != nil {
		logrus.Fatal(err)
	}

	pngBytes, err := os.ReadFile("validation/weeklyTestsReports/assets/rancher.png")
	if err != nil {
		logrus.Fatal(err)
	}
