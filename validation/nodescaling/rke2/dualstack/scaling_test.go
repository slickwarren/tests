...
func (s *NodeScalingDualstackTestSuite) TestScalingDualstackNodePools() {
	...
	tests := []struct {
		...
		{"RKE2_Dualstack_Scale_Control_Plane", nodeRolesControlPlane, 1, s.cluster},
		{"RKE2_Dualstack_Scale_ETCD", nodeRolesEtcd, 1, s.cluster},
		{"RKE2_Dualstack_Scale_Worker", nodeRolesWorker, 1, s.cluster},
	}
